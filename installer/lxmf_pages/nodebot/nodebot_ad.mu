...
p("")
p("`c`F5cc`!" + bot_name + "`!`f")
p("`c`F888Mesh Network Chatbot`f")
p("`c`F555" + net_str + "`f")
p("`l")
p("")
p("-")
...
# Hook
# ─────────────────────────────────────────────────────────────
p("`cYou have reached a live mesh network node.")
p("")
p("`c`!" + bot_name + "`! is an open-source chatbot running on a Raspberry Pi,")
p("`cconnected to the mesh by LoRa radio.")
p("")
p("`c`F888No internet. No data plan. Just radio waves.`f")
p("")
p("-")
p("")
...
p(">Run your own node")
p("")
p("`c`F888NodeBot is free and open-source. Anyone can run one.`f")
p("`cRaspberry Pi + a LoRa radio module is all you need.")
p("")
p("`c`[github.com/JamesM92/NodeBot`Fbbf`]")
p("")
p("`c`F555" + bot_name + " · NodeBot v0.3.0`f")
p("")
