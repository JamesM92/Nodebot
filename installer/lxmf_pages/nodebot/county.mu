...
if fresh:
    ...
    print("`F888  Left:   Node count  (teal, darker = more nodes)`f")
    print("`F888  Centre: Activity    (amber, darker = more traffic)`f")
    print("`F888  Right:  Avg RSSI    (red=weak → blue=strong, with dBm scale)`f")
